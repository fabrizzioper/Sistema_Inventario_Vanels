document.addEventListener("DOMContentLoaded", () => {
    ...
    // Plantilla para el contenedor de talla con botón de eliminar
    ...
    const loadProductData = (card, productData) => {
      ...
      productData.tallas.forEach((talla) => {
        ...
        // **Eliminar el botón de eliminar para tallas iniciales**
        const removeButton = sizeRow.querySelector(".btn-remove-size");
        if (removeButton) {
          removeButton.parentElement.remove(); // Remover el contenedor del botón
        }
    ...
    // Función para agregar una talla dinámicamente
